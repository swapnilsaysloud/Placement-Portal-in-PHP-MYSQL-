                    ...
                    <div class="row">
                       <div class="col-md-6 col-sm-6">
                           <div class="topbar-left">
                                <ul>
                                    <li><a href="#"><i class="fa fa-envelope"></i> IIT Patna</a></li>
                                    <li><a href="#"><i class="fa fa-phone"></i> TPC</a></li>
                                </ul>
							</div>
                        </div>
                    </div>
                            ...
                            <div class="login-form">
                                ...
                                <div class="row">
                                    <form id="contactForm" method="POST" action="http://rockstheme.com/rocks/aievari-live/contact.php" class="log-form">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <button type="submit" id="submit" class="login-btn"><a href="Combined\service.html">Login</a></button>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="sign-icon">
                                                ...
                                                <div class="acc-not">Don't have an account  <a href="Admin2\signup.html"> Sign up</a></div>
                                            </div> 
                                        </div> 
                                    </form> 
                                </div>
